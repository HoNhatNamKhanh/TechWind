        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-body px-0 pt-0 pb-2">
                    <h3 class="text-2xl py-3 px-4 font-semibold text-gray-800 dark:text-gray-200">Chỉnh sửa đơn hàng
                    </h3>
                    <form action="{{ route('admin.orders.update', $order->id) }}" method="POST">
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 variant">
                            ...
                            <label class="block text-sm mb-4">
                                <span class="text-xl py-3 text-gray-700 dark:text-gray-400">Mã đơn hàng</span>
                                <input type="text"
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    placeholder="Nhập mã đơn hàng" name="code" value="{{ old('code', $order->code) }}"
                                    required />
                                @error('code')
                            ...
                            <!-- Customer Name -->
                            <label class="block text-sm mb-4">
                                <span class="text-xl py-3 text-gray-700 dark:text-gray-400">Tên khách hàng</span>
                                <input type="text"
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            ...
                            <h4 class="text-xl py-3 font-semibold text-gray-800 dark:text-gray-200 mb-4">Sản phẩm trong
                                đơn hàng</h4>
                                    ...
                                    <table class="w-full table-auto border-collapse">
                                        <thead>
                                            <tr
                                                ...
                                                <th class="px-4 py-2 text-left">Màu
                                                </th>
                                        ...
                                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                            @foreach($order->orderItems as $orderItem)
                                                <tr class="text-gray-700 dark:text-gray-400">
                                                    ...
                                                    <td class="px-4 py-2">{{ $orderItem->color }}</td>
                                                    <td class="px-4 py-2">{{ $orderItem->quantity }}</td>
                            ...
                            <label class="block text-sm mt-4">
                                <span class="text-xl py-3 text-gray-700 dark:text-gray-400">Tổng giá trị đơn hàng</span>
                                <input type="text"
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            ...
                            <label class="block text-sm mb-4 mt-4">
                                <span class="text-xl py-3 text-gray-700 dark:text-gray-400">Trạng thái đơn hàng</span>
                                <select name="status"
                            ...
                            <!-- Submit Button -->
                            <div
                                class="mb-4 my-6 text-lg font-semibold text-gray-600 dark:text-gray-300 border-gray-300 dark:border-gray-600">
                                <div
