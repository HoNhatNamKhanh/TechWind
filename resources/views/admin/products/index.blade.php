...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
        ...
        <h4 class="mb-4 text-lg font-semibold text-white dark:text-gray-300 border-gray-300 dark:border-gray-600 ">
            <div
                class="w-56 text-center  create-button px-2 py-2 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 ">
                                    ...
                                    <td class="align-middle text-center border px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            ...
                                            <form action="{{ route('admin.variants.destroy', $variant->id) }}" method="POST"
                                                style="display:inline;" onclick="return confirm('Bạn muốn xoá biến thể này?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none">
